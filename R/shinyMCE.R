...
tinyMCE <- function(inputId, content, options = NULL){
  tagList(
    singleton(tags$head(tags$script(src ="https://cdn.tiny.cloud/1/3l1bs056i8cb0dmxgwh07a1woafwsgjdxyagk4t24fyvr8di/tinymce/6/tinymce.min.js", referrerpolicy="origin"))),
